...
urlpatterns = [
    ...
    path("tasks/create/<int:pk>/<int:day_number>", TaskWeekCreateView.as_view(), name="task-week-create"),
    path("tasks/<int:pk>/update/", TaskUpdateView.as_view(), name="task-update"),
    path("tasks/<int:pk>/delete/", TaskDeleteView.as_view(), name="task-delete"),
    path("tasks/<int:pk>/delete/<int:week_pk>", TaskWeekDeleteView.as_view(), name="task-week-delete"),
