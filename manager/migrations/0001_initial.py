    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('priority', models.CharField(choices=[('TO-DO', 'TO-DO'), ('URGENT', 'URGENT'), ('OPTIONAL', 'OPTIONAL')], default='TO-DO', max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('difficulty', models.CharField(choices=[('EASY', 'EASY'), ('CAN BE', 'CAN BE'), ('HARD WORK', 'HARD WORK')], default='CAN BE', max_length=20, null=True)),
